...
export default function Hero() {
    ...
    return (
        <section className="pt-24 bg-no-repeat bg-cover" style={{backgroundImage: "url(./hero-background.png)"}}>
            <div className="px-12 mx-auto max-w-7xl">
                <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
                    <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">
                        <span>Match</span> <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-primary to-blue-600 lg:inline">Supply & Demand
                        </span> <span>Quickly And Effectively</span>
                    </h1>
                    <p className="px-0 mb-8 text-lg text-gray-600 md:text-xl lg:px-24">
                    cloud-based transport matching system for charterers in the inland shipping industry
                    </p>
                ...
                <div className="w-full mx-auto mt-20 text-center md:w-10/12">
                    <div className="relative z-0 w-full mt-8">
                        <div className="relative overflow-hidden shadow-2xl">
                            <div className="flex items-center flex-none px-4 bg-primary rounded-b-none h-8 rounded-xl">
